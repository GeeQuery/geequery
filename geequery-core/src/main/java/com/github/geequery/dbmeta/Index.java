...
//	private static String generateName(String tablename, List<SimpleExpr> fields, DatabaseDialect dialect, EntityMetadata meta) {
//		StringBuilder iNameBuilder = new StringBuilder();
//		iNameBuilder.append("IDX_").append(StringUtils.truncate(StringUtils.removeChars(tablename, '_'), 14));
//		int maxField = ((28 - iNameBuilder.length()) / fields.size()) - 1;
//		if (maxField < 1)
//			maxField = 1;
//		for (SimpleExpr field : fields) {
//			iNameBuilder.append('_');
//			if (field.type()==SimpleExprType.field) {
//				iNameBuilder.append(StringUtils.truncate(meta.getColumnDef((Field)field).getColumnName(dialect, false), maxField));
//			} else {
...
//	 * @return
//	 */
//	public static Index valueOf(IndexDef indexDef, EntityMetadata meta, DatabaseDialect dialect, String tablename) {
//		String schema = null;
...
//		}
//
//		List<SimpleExpr> fields = new ArrayList<SimpleExpr>();
...
//			if (field != null) {
//				columns.add(new IndexItem(meta.getColumnName(field, dialect, true), asc, 0));
//				fields.add(field);
//			} else {
//				// 可能是一个函数索引
//				columns.add(new IndexItem(fieldname, asc, 0));
//				fields.add(new JpqlExpression(fieldname, ReadOnlyQuery.getEmptyQuery(meta)));	
//			}
//		}
//
