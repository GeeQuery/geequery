...
//	void processConnectProperties(DataSourceInfo dsw);
	 ...
	 */
//	ColumnType getProprtMetaFromDbType(Column dbTypeName);
	 ...
	 * @return 序列的信息
	 */
	List<SequenceInfo> getSequenceInfo(SchemaHandler conn, String schema, String seqName)  throws SQLException;
	 ...
	 * @return 约束的信息
	 */
	List<Constraint>   getConstraintInfo(SchemaHandler conn,String schema, String tablename, String constraintName) throws SQLException;
	 ...
	 */
	Map<String, FunctionDialect> getFunctions();

	/**
	 * 返回所有标准函数
	 * @return 当前数据库方言中内置的所有支持的函数
	 */
	Map<DbFunction, FunctionDialect> getFunctionsByEnum();
