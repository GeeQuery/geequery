...
//	}
	...
	private static com.github.geequery.common.Entry<String, Integer> toKeyAndIndex(String name, int x, int y) {
		try {
			return new com.github.geequery.common.Entry<String, Integer>(name.substring(0, x), Integer.parseInt(name.substring(x + 1, y)));
