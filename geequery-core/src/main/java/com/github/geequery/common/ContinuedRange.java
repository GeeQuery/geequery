...
public abstract class ContinuedRange<T extends Comparable<T>> implements Range<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.common.Range#isContinuous()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.common.Range#getGreatestValue()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.common.Range#getLeastValue()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.github.geequery.common.Range#contains(java.lang.Comparable)
	 */
