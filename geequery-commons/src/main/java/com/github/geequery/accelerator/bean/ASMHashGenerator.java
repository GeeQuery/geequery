...
import com.github.geequery.tools.reflect.UnsafeUtils;
...
final class ASMHashGenerator extends ClassGenerator {
	...
	private byte[] generateMain() {
		...
		{
			MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "getProperty", ASMUtils.getMethodDesc(com.github.geequery.tools.reflect.Property.class, String.class), null,null);
			mw.visitVarInsn(ALOAD, 0);
			mw.visitFieldInsn(GETFIELD, accessorType, "fields", "Ljava/util/Map;");
		...
		}
		{
			...
			mw.visitFieldInsn(GETFIELD, getType(com.github.geequery.accelerator.bean.AbstractFastProperty.class), "n", "I"); //S2==int
		...
		}
		{
			...
			mw.visitFieldInsn(GETFIELD, getType(com.github.geequery.accelerator.bean.AbstractFastProperty.class), "n", "I"); //S2==int 获取序号
