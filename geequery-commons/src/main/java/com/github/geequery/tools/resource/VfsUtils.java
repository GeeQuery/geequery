...
import com.github.geequery.tools.reflect.ReflectionUtils;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Utility for detecting the JBoss VFS version available in the classpath. JBoss
 * AS 5+ uses VFS 2.x (package {@code org.jboss.virtual}) while JBoss AS 6+ uses
 * VFS 3.x (package {@code org.jboss.vfs}).
 * 
 * <p>
