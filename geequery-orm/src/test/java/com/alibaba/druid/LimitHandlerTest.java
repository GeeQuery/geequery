...
import com.github.geequery.dialect.handler.DerbyLimitHandler;
...
import com.github.geequery.dialect.handler.MySqlLimitHandler;
import com.github.geequery.dialect.handler.OracleLimitHander;
import com.github.geequery.dialect.handler.SQL2000LimitHandler;
import com.github.geequery.dialect.handler.SQL2005LimitHandler;
...
"\nORDER BY name";
	...
	private void doAssert(String raw, LimitHandler lh, String expect) {
		SQLBindings sql=lh.toPageSQL(raw, pageParam);
	...
	public void testWhenOffsetIs0(){
		...
		SQLBindings sql=lh.toPageSQL(sqls[0],new PageLimit(0,15));
