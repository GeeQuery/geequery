 ...
 */
package com.github.geequery.jsqlparser.statement.replace;
...
public class Replace implements Statement {
    ...
    /**
	 * A list of {@link com.github.geequery.jsqlparser.expression.Column}s either from a "REPLACE mytab (col1, col2) [...]" or a "REPLACE mytab SET col1=exp1, col2=exp2". 
	 * @return a list of {@link com.github.geequery.jsqlparser.expression.Column}s
	 */
    ...
    /**
	 * A list of {@link com.github.geequery.jsqlparser.visitor.Expression}s (from a "REPLACE mytab SET col1=exp1, col2=exp2"). <br>
