...
import com.github.geequery.entity.IndexDef;
...
//	private static String generateName(String tablename, List<SimpleExpr> fields, DatabaseDialect dialect, ITableMetadata meta) {
//		StringBuilder iNameBuilder = new StringBuilder();
//		iNameBuilder.append("IDX_").append(StringUtils.truncate(StringUtils.removeChars(tablename, '_'), 14));
