 ...
 *
 */
public class FunctionMapping implements FunctionDialect {
	...
	/**
	 * 1、数据库的函数已经实现了所需要的标准函数。无需任何更改 2、数据库的函数和标准函数参数含义（基本）一样，仅需变化一下名称，如 nvl ->
	 * ifnull 3、数据库的函数和标准函数差别较大，通过多个其他函数模拟实现。（参数一致）
	 * 
	 * @see #MATCH_FULL
