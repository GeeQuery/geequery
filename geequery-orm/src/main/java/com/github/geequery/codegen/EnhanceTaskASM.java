...
import com.github.geequery.accelerator.asm.commons.AnnotationDef;
import com.github.geequery.accelerator.asm.commons.FieldExtCallback;
import com.github.geequery.accelerator.asm.commons.FieldExtDef;
...
//				}
	...
	static class GetterVisitor extends MethodVisitor implements Opcodes {
		...
		public void visitMaxs(int maxStack, int maxLocals) {
			//这里有问题，如果原来的方法里有一定逻辑，这里的maxStack=2显然不合适
	...
	static class SetterVisitor extends MethodVisitor implements Opcodes {
		...
		@Override
		public void visitMaxs(int maxStack, int maxLocals) {
			mv.visitMaxs(Math.max(4,maxStack), maxLocals);
		}
	}
}
