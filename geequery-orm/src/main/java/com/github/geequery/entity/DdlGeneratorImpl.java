...
public class DdlGeneratorImpl implements DdlGenerator {
	 ...
	 * java.lang.String)
	 */
	public TableCreateSQLs toTableCreateClause(EntityMetadata meta, String tablename) {
	...
	public List<String> toTableModifyClause(EntityMetadata meta, String tableName, Map<String, ColumnType> insert, List<ColumnModification> changed,
			List<String> delete) {
