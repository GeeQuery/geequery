 ...
 * 
 */
public abstract class AbstractMetadata<T> implements EntityMetadata<T> {
	/**
...
//	}
//
//	protected ReferenceObject innerAdd(Property pp, EntityMetadata target, CascadeConfig config) {
...
//	 */
//	protected ReferenceObject addCascadeField(String fieldName, EntityMetadata target, CascadeConfig config) {
...
//			throw new IllegalArgumentException(fieldName + " is not exist in " + this.getName());
//		}
//		return innerAdd(pp, target.getColumnMapping(), config);
//	}
//
