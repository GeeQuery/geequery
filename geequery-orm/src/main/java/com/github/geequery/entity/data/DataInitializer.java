...
import com.github.geequery.annotation.InitializeData;
...
import com.github.geequery.jre5support.ProcessUtil;
import com.github.geequery.tools.StringUtils;
import com.github.geequery.tools.csvreader.Codecs;
import com.github.geequery.tools.csvreader.CsvReader;
...
public class DataInitializer {
	...
	public DataInitializer(SessionFactory session, boolean useTable, String charset, String extName) {
	...
	private List<IQueryableEntity> readData(EntityMetadata meta, URL url, String charset) throws UnsupportedEncodingException, IOException {
	...
	private int initData0(EntityMetadata meta, URL url, String charset, boolean manualSequence) throws IOException {
		int count = 0;
	...
	private int mergeData0(EntityMetadata meta, URL url, String charset, boolean manualSequence, String[] mergeKey) throws IOException {
		int count = 0;
	 ...
	 *            表是否刚刚创建
	 */
	public final void initData(EntityMetadata meta, boolean isNew) {
	...
	private void initSqlData(EntityMetadata meta, boolean isNew, String resName, boolean ensureResourceExists, String charset) {
		String tableName = meta.getTableName(false);
	...
	private void initCSVData(EntityMetadata meta, boolean isNew, String resName, boolean manualSequence, boolean ensureResourceExists, String charset,
			String[] mergeKey) {
		String tableName = meta.getTableName(false);
		URL url = meta.getThisType().getResource(resName);
		if (url != null) {
