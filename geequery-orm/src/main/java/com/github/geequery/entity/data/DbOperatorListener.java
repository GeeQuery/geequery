...
public interface DbOperatorListener {
	 ...
	 */
	void beforeInseret(IQueryableEntity obj, Session abstractSessionFactory);
	 ...
	 * @param abstractSessionFactory
	 */
	void afterInsert(IQueryableEntity obj, Session abstractSessionFactory);
	...
	/**
	 * 当整个SessionFactory关闭时执行
	 */
	void onSessionFactoryClose();
}
