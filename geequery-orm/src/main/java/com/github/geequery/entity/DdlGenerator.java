...
public interface DdlGenerator {
	 ...
	 * @return
	 */
	TableCreateSQLs toTableCreateClause(EntityMetadata obj, String tablename);

	/**
	 * 生成Alter table 语句
	 * @return
	 */
	List<String> toTableModifyClause(EntityMetadata meta,String tableName, Map<String, ColumnType> insert, List<ColumnModification> changed, List<String> delete);
