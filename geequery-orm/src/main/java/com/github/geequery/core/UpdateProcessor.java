...
import com.github.geequery.core.Session.UpdateContext;
...
import com.github.geequery.dialect.type.VersionSupportColumn;
...
public abstract class UpdateProcessor {
	...
	public static UpdateProcessor get(DatabaseDialect profile, DbClient db) {
	...
	final static class PreparedImpl extends UpdateProcessor {
		...
		@Override
		public BindSql toWhereClause(JoinElement joinElement, SqlContext context, UpdateContext update, DatabaseDialect profile) {
