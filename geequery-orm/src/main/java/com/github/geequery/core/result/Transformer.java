 ...
 * 用户可以使用此类——
 * <ul>
 * <li>{@linkplain #setResultType(Class)} | {@linkplain #setResultType(EntityMetadata)}<br>指定查询的操作结果</li>
...
public class Transformer {
	 ...
	 * @param strategies 返回结果转换策略
	 */
	public Transformer(EntityMetadata meta, PopulateStrategy... strategies) {
		setResultType(meta);
		this.strategy = strategies;
	}
	 ...
	 */
	public EntityMetadata getResultMeta() {
		return meta;
	}
	 ...
	 */
	public void setResultType(EntityMetadata meta) {
		if (meta == null)
			return;
