...
public final class SequenceManager {
	...
	protected SequenceManager(SessionFactory parent) {
		this.parent = parent;
	}
	...
	private static final class AdvSeqTableImpl extends AbstractSequence {
		...
		@Override
		protected long getFirstAndPushOthers(int num, SessionFactory conn, String dbKey) throws SQLException {
		...
		@Override
		protected boolean doInit(SessionFactory session, String dbKey) throws SQLException {
