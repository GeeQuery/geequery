//package com.github.geequery.query.nativeq;
//
...
//		Statement statement;
//		com.github.geequery.jsqlparser.statement.select.Select count;
...
//	 * 解析SQL语句，改写
//	 */
//	private static DialectCase analy(String sql, int type, Connection db) throws SQLException {
//		final DatabaseDialect dialect = db.getProfile();
//		try {
//			Statement st = Parsers.parseStatement(sql);
...
//		DialectCase dc = getDialectCase(db);
//		if (dc.count == null) {
//			if (dc.statement instanceof com.github.geequery.jsqlparser.statement.select.Select) {
//				SelectBody oldBody = ((com.github.geequery.jsqlparser.statement.select.Select) dc.statement).getSelectBody();
...
//				}
//				com.github.geequery.jsqlparser.statement.select.Select ctst = new com.github.geequery.jsqlparser.statement.select.Select();
